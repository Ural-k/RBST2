...
public class StartDirector : MonoBehaviour
{
    ...
    [SerializeField] private Image nanamebou1_;     //1‚Â–Ú‚ÌŽÎ‚ß–_‚Ì˜gUI
    ...
    [SerializeField] private Image nanamebou2_;     //1‚Â–Ú‚ÌŽÎ‚ß–_‚Ì“h‚èUI
    ...
    void StartFill()
    {
        StopAllCoroutines(); // ©‚±‚ê’´d—v
        ResetImages();       // ©Š®‘SƒŠƒZƒbƒg‚µ‚Ä‚©‚çŠJŽn
